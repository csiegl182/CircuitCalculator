...
from CircuitCalculator.NodalAnalysis import nodal_analysis_solver as advanced_nodal_analysis_solver
import numpy as np
...
def test_network_5_with_advanced_nodal_analysis() -> None:
    ...
    solution = advanced_nodal_analysis_solver(network)
    R1, R2, R3, R4, U1, U2, U3, I1 = tuple(network.branches)
    ...
    np.testing.assert_almost_equal(solution.get_voltage(I1), -2.7, decimal=2)
    ...
    np.testing.assert_almost_equal(solution.get_current(I1), 0.1, decimal=3)
...
def test_network_9_with_advanced_nodal_analysis() -> None:
    ...
    solution = advanced_nodal_analysis_solver(network)
    Iq, R1, R2, R3, Uq, R4 = tuple(network.branches)
