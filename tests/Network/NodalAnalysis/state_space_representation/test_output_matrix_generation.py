...
def test_output_matrix_of_transient_network_1() -> None:
    ...
    _, _, C, _ = state_space_matrices_for_potentials(network, [BranchValues(value=C, id='C', node1='3', node2='0')])
...
def test_output_matrix_of_transient_network_2() -> None:
    ...
    _, _, C, _ = state_space_matrices_for_potentials(network, [BranchValues(value=C, id='C', node1='2', node2='3')])
...
def test_output_matrix_of_transient_network_4() -> None:
    ...
    _, _, C, _ = state_space_matrices_for_potentials(network, [BranchValues(value=C1, id='C1', node1='2', node2='3'), BranchValues(value=C2, id='C2', node1='3', node2='0')])
