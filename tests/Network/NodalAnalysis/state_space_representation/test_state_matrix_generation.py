...
def test_state_matrix_of_transient_network_1() -> None:
    ...
    A, _, _, _ = state_space_matrices_for_potentials(network, [BranchValues(value=C, id='C', node1='3', node2='0')])
...
def test_state_matrix_of_transient_network_2() -> None:
    ...
    A, _, _, _ = state_space_matrices_for_potentials(network, [BranchValues(value=C, id='C', node1='2', node2='3')])
    assert_almost_equal(A, np.array([[-(R1 + R2)/(C*(R1*R2 + R1*R3 + R2*R3))]]), decimal=5)
...
def test_state_matrix_of_transient_network_4() -> None:
    ...
    A, _, _, _ = state_space_matrices_for_potentials(network, [BranchValues(value=C1, id='C1', node1='2', node2='3'), BranchValues(value=C2, id='C2', node1='3', node2='0')])
