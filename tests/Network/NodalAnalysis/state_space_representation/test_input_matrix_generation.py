...
def test_input_matrix_of_transient_network_1() -> None:
    ...
    _, B, _, _ = state_space_matrices_for_potentials(network, [BranchValues(value=C, id='C', node1='3', node2='0')])
...
def test_input_matrix_of_transient_network_2() -> None:
    ...
    _, B, _, _ = state_space_matrices_for_potentials(network, [BranchValues(value=C, id='C', node1='2', node2='3')])
    assert_almost_equal(B, np.array([[R2/(C*(R1*R2 + R1*R3 + R2*R3))]]))
...
def test_input_matrix_of_transient_network_4() -> None:
    ...
    _, B, _, _ = state_space_matrices_for_potentials(network, [BranchValues(value=C1, id='C1', node1='2', node2='3'), BranchValues(value=C2, id='C2', node1='3', node2='0')])
