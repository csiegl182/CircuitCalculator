...
matplotlib.use('Agg')
from CircuitCalculator.SimpleCircuit.DiagramParser import SchematicDiagramAnalyzer, round_node, UnknownElement
...
def test_all_circuit_elements_can_be_accessed() -> None:
    sd = SimpleDrawing()
    schemdraw_network = SchematicDiagramAnalyzer(sd.drawing)
