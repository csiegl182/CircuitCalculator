...
def test_list_of_circuit_elements_can_be_transformed_into_network_with_same_node_labels() -> None:
    elem1_nodes = ('1', '0')
    elem2_nodes = ('0', '1')
    circuit = Circuit([VoltageSource(V=1, nodes=elem1_nodes, id='V1'), Resistor(R=100, nodes=elem2_nodes, id='R1'), Ground(('0', ))])
...
def test_list_of_circuit_elements_can_be_transformed_into_network_with_same_element_names() -> None:
    ...
    elem1_nodes = ('1', '0')
    elem2_nodes = ('0', '1')
    circuit = Circuit([VoltageSource(V=U, nodes=elem1_nodes, id='V1'), Resistor(R=R, nodes=elem2_nodes, id='R1'), Ground(('0', ))])
...
def test_ground_node_is_transformed_into_network() -> None:
    ...
    elem1_nodes = ('1', '0')
    elem2_nodes = ('0', '1')
    circuit = Circuit([VoltageSource(V=U, nodes=elem1_nodes, id='V1'), Resistor(R=R, nodes=elem2_nodes, id='R1'), Ground(('1', ))])
